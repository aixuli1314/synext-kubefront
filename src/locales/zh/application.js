...
export default {
  ...
  APPLICATION_TYPE_DESC:
    'Synext 支持来自于应用商店和应用仓库的应用部署(基于 Helm)，同样也支持自制应用 (Application CRD)。',
  ...
  FROM_APP_STORE_DESC:
    '来自Synext官方应用商店，提供高质量应用和简易的部署方式',
  ...
  APP_TEMPLATES_MODAL_DESC:
    '应用模板来自于企业空间和第三方的Helm应用模板，支持一键部署并可通过可视化的方式在Synext中展示并提供部署及管理的功能',
  APP_REPOS_DESC:
    '应用仓库来自于第三方的 Helm Chart Repo，通过可视化的方式在 Synext 中展示并提供部署及管理功能，用户可以基于应用仓库中的模板快速地一键部署应用。',
